...
public class OpenApiConfig {
  ...
  public OpenAPI promoServiceOpenAPI() {
    OpenAPI api = new OpenAPI().info(new Info().title("CreditX Promotion Service API")
            .description("Promotion evaluation and cashback processing APIs").version("v1")
  ...
  public OpenApiCustomizer internalTagHidingCustomiser() {
    return openApi -> {
      if (showInternal || openApi.getPaths() == null) {
        return;
      }
